    ...
    <div class="container">
        ...
        <div class="row">
            ...
            box-shadow: 0px 0px 3px rgba(0,0,0,0.4);">
                <!-- Types of Login -->
                <div class="tab">
                    <button class="tablinks" onclick="openCity(event, 'Report')" id="defaultOpen">Vehicle Registration</button>
                </div>
                    ...
                    <div class="container" style="width:100%; margin-top:2%;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10">
                                ...
                                <div class="col-md-4">
                                    <form action="auth_vehicle_registration.php" method="GET">
                            ...
                            <?php 
                                ...
                                $queryv = "SELECT * FROM vehicleregistration ORDER BY id ASC";
                                ...
                                if(isset($_GET['searchsubmit']))
                                {
                                      ...
                                      $querysearch="SELECT * FROM vehicleregistration WHERE (`licenseplateno` LIKE '%".$search_string."%')";
